...
Public Class InventoryReportForm
    ...
    Private Sub LoadCategories()
        Try
            ...
            Using conn As New SqlConnection(_connString)
                conn.Open()
                Dim sql As String = "IF OBJECT_ID('dbo.Retail_Product','U') IS NOT NULL " & _
                                    "SELECT DISTINCT Category FROM dbo.Retail_Product WHERE Category IS NOT NULL ORDER BY Category " & _
