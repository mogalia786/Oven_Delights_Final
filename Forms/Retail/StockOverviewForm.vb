            ...
            Using conn As New SqlConnection(_connString)
                ...
                Using tx = conn.BeginTransaction()
                    Try
                        ...
                        Using cmd As New SqlCommand("INSERT INTO dbo.Retail_StockMovements(VariantID, BranchID, MovementDate, QuantityChange, Reason) VALUES(@vid, @bid, GETDATE(), @qty, @rsn)", conn, tx)
