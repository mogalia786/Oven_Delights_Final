...
Public Class StockroomInventoryForm
    ...
    Private Sub LoadCategories()
        Try
            Using conn As New SqlConnection(_connString)
                Dim sql = "SELECT DISTINCT Category FROM Stockroom_Product WHERE Category IS NOT NULL ORDER BY Category"
            ...
            Using conn As New SqlConnection(_connString)
                ...
                If isSuperAdmin Then
                    sql = "SELECT p.ProductID, p.ProductCode, p.ProductName, 
                           ...
                           ISNULL(rs.QuantityInStock, 0) AS CurrentStock,
                           ISNULL(rs.ReorderLevel, 0) AS ReorderLevel,
    ...
    Private Sub DeleteProduct(productId As Integer)
        Using conn As New SqlConnection(_connString)
            conn.Open()
            Using cmd As New SqlCommand("UPDATE Stockroom_Product SET IsActive = 0 WHERE ProductID = @productId", conn)
