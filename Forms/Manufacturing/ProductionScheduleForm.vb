        ...
        Try
            Using conn As New SqlConnection(_connString)
                ...
                Dim sql As String = "IF OBJECT_ID('dbo.v_Manufacturing_ProductionSchedule','V') IS NOT NULL " & _
                                    ...
                                    "SELECT ps.ScheduleID, ISNULL(p.Name, 'Unknown Product') AS ProductName, ps.ScheduledDate, ps.Quantity, " & _
                                    ...
                                    "LEFT JOIN dbo.Manufacturing_Product p ON p.ProductID = ps.ProductID " & _
