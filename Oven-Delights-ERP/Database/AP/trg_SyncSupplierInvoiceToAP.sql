-- =============================================
-- Trigger: trg_SyncSupplierInvoiceToAP
-- Automatically syncs new SupplierInvoices to AP_Invoices for batch payments
-- =============================================
...
PRINT 'Trigger trg_SyncSupplierInvoiceToAP created successfully'
PRINT 'New supplier invoices will automatically sync to AP_Invoices for batch payments'
GO
