...
BEGIN
    ...
    ORDER BY 
        CASE ItemType 
            WHEN 'Sub-Recipe' THEN 1  -- Sub-recipes first
...
PRINT '✅ sp_GetScaledBOMFromRecipe updated successfully!';
PRINT '   NOW INCLUDES SUB-RECIPES as separate line items for stock checking';
GO
