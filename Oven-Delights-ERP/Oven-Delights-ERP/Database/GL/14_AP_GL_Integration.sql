-- =============================================
-- Accounts Payable GL Integration Procedures
-- =============================================

-- =============================================
-- sp_AP_PostAdhocInvoiceToGL - Post ADHOC Invoice to GL (without PO/GRV)
-- =============================================
CREATE OR ALTER PROCEDURE sp_AP_PostAdhocInvoiceToGL
    @InvoiceID INT,
...
-- =============================================
-- sp_AP_PostSinglePaymentToGL - Post Single Supplier Payment to GL
-- =============================================
CREATE OR ALTER PROCEDURE sp_AP_PostSinglePaymentToGL
    @InvoiceID INT,
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT @JournalID AS JournalID, 'Payment posted to GL successfully' AS Message
    END TRY
    BEGIN CATCH
        ROLLBACK TRANSACTION;
        THROW;
...
-- =============================================
-- sp_AP_PostBatchPaymentToGL - Post Batch Payment to GL (FNB Integration)
-- Called when FNB confirms successful payment
-- =============================================
CREATE OR ALTER PROCEDURE sp_AP_PostBatchPaymentToGL
    @BatchID INT,
    @PaymentDate DATE,
    @CreatedBy INT
AS
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT 'Batch payment posted to GL successfully' AS Message
    END TRY
    BEGIN CATCH
...
-- =============================================
-- sp_AP_PostCreditNoteToGL - Post Supplier Credit Note to GL
-- =============================================
CREATE OR ALTER PROCEDURE sp_AP_PostCreditNoteToGL
    @CreditNoteID INT,
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT @JournalID AS JournalID, 'Credit note posted to GL successfully' AS Message
    END TRY
    BEGIN CATCH
        ROLLBACK TRANSACTION;
        THROW;
...
PRINT 'AP GL Integration procedures created successfully'
GO
