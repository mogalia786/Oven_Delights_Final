            ...
            Try
                Using conn As New SqlConnection(_connectionString)
                    ...
                    Dim sql = "SELECT 
                        ...
                        0 AS Balance,
                        CASE WHEN ISNULL(ast.IsMapped, 0) = 0 THEN 'Unmatched' ELSE 'Matched' END AS Status,
                        CASE WHEN ISNULL(ast.IsMapped, 0) = 1 THEN 'Yes' ELSE 'No' END AS IsMapped,
                        NULL AS MatchedPaymentRef,
                        NULL AS MatchedPaymentType,
                        CASE WHEN ast.IsReconciled = 1 THEN 'Yes' ELSE 'No' END AS Posted
