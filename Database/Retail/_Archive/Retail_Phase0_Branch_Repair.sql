...
/* 0) Drop views first to avoid dependency errors during table/column repairs */
...
/* 2) Add/repair BranchID and computed keys/constraints */
...
/* 3) Views: recreate with BranchID */
IF OBJECT_ID('dbo.v_Retail_ProductCurrentPrice','V') IS NOT NULL DROP VIEW dbo.v_Retail_ProductCurrentPrice;
GO
