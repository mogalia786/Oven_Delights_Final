-- Create Stockroom_PurchaseOrders table in Azure database
...
BEGIN
    ...
    CREATE INDEX IX_Stockroom_PO_Supplier ON Stockroom_PurchaseOrders (SupplierID)
    CREATE INDEX IX_Stockroom_PO_Status ON Stockroom_PurchaseOrders (Status)
    CREATE INDEX IX_Stockroom_PO_Date ON Stockroom_PurchaseOrders (PODate)
...
BEGIN
    ...
    CREATE INDEX IX_Stockroom_POLines_PO ON Stockroom_PurchaseOrderLines (POID)
    CREATE INDEX IX_Stockroom_POLines_Material ON Stockroom_PurchaseOrderLines (MaterialID)
...
PRINT 'Stockroom Purchase Order tables setup completed'
